...
import ntq.uet.server.model.common.DeliveryUrlConstant;
...
public class DeliveryService {
    ...
    public int GHNGetProvinceId(String token, String provinceName) {
        ...
        ResponseEntity<Map<String, Object>> responseEntity = restTemplate.exchange(
                DeliveryUrlConstant.GHN_DEV_BASE_URL + DeliveryUrlConstant.GHN_GET_PROVINCE, HttpMethod.POST, entityRequest,
                responseType);
    ...
    public int GHNGetDistrictId(String token, String provinceName, String districtName) {
        ...
        ResponseEntity<Map<String, Object>> responseEntity = restTemplate.exchange(
                DeliveryUrlConstant.GHN_DEV_BASE_URL + DeliveryUrlConstant.GHN_GET_DISTRICT, HttpMethod.POST, entityRequest, responseType);
    ...
    public String GHNGetWardCode(String token, int districtId, String wardName) {
        ...
        ResponseEntity<Map<String, Object>> responseEntity = restTemplate.exchange(
                DeliveryUrlConstant.GHN_DEV_BASE_URL + DeliveryUrlConstant.GHN_GET_WARD, HttpMethod.POST, entityRequest, responseType);
    ...
    public String GHNCreateOrder(String token, String shopId, Delivery delivery) {
        ...
        ResponseEntity<Map<String, Object>> responseEntity = restTemplate.exchange(
            DeliveryUrlConstant.GHN_DEV_BASE_URL + DeliveryUrlConstant.GHN_CREATE_ORDER, HttpMethod.POST, entityRequest, responseType);
    ...
    public String GHNGetStatus(String token, String shopId, String orderCode) {
        ...
        ResponseEntity<Map<String, Object>> responseEntity = restTemplate.exchange(
            DeliveryUrlConstant.GHN_DEV_BASE_URL + DeliveryUrlConstant.GHN_ORDER_DETAIL, HttpMethod.POST, entityRequest, responseType);
    ...
    public String GHNGetPrintOrdersLink(String token, List<String> orderCodes) {
        ...
        ResponseEntity<Map<String, Object>> responseEntity = restTemplate.exchange(
            DeliveryUrlConstant.GHN_DEV_BASE_URL + DeliveryUrlConstant.GHN_GET_PRINT_ORDER, HttpMethod.POST, entityRequest, responseType);

        Map<String, Object> map = responseEntity.getBody();
        JSONObject jsonObject = (new JSONObject(map)).getJSONObject("data");

        return DeliveryUrlConstant.GHN_PRINT_ORDER + jsonObject.getString("token");
    }
}
